...
# SPLIT_PATH = osp.join(ROOT_PATH2, 'FEAT\\data\\cub\\split')
IMAGE_PATH1 = osp.join(ROOT_PATH1, 'data', 'cub', 'images')  # C:\DataSet\FEAT\data\miniimagenet\images
SPLIT_PATH = osp.join(ROOT_PATH1, 'data', 'cub', 'split')     # C:\DataSet\FEAT\data\miniimagenet\split
